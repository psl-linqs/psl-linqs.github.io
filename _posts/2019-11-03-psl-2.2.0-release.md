...
The full API for the PSLModel class can be found [here](/api/2.2.0/org/linqs/psl/java/PSLModel.html).
...
[Functional predicates](/wiki/2.2.0/External-Functions.html) are now supported in the CLI.
...
We have added the [`FloatMatrix`](/api/2.2.0/org/linqs/psl/util/FloatMatrix.html) class to handle low-level matrix operations.
...
Grounding results can now be streamed from the database using the [`QueryResultIterable`](/api/develop/org/linqs/psl/database/QueryResultIterable.html) class.
...
A new class, [RuntimeStats](/api/develop/org/linqs/psl/util/RuntimeStats.html),
...
In contrast, likelihood-based methods (e.g. [Maximum Likelihood MPE](/api/2.2.0/org/linqs/psl/application/learning/weight/maxlikelihood/MaxLikelihoodMPE.html)) maximize the likelihood,
...
The class for GPP is [`org.linqs.psl.application.learning.weight.bayesian.GaussianProcessPrior`](/api/2.2.0/org/linqs/psl/application/learning/weight/bayesian/GaussianProcessPrior.html).
You can choose an evaulator by setting the `weightlearning.evaluator` configuration option to any [Evaluator](/api/2.2.0/org/linqs/psl/evaluation/statistics/Evaluator.html).
...
Domain: Any [Evaluator](/api/2.2.0/org/linqs/psl/evaluation/statistics/Evaluator.html)  
Default: [ContinuousEvaluator](/api/2.2.0/org/linqs/psl/evaluation/statistics/ContinuousEvaluator.html)  
