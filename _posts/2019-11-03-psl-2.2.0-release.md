...
Grounding results can now be streamed from the database using the [`QueryResultIterable`](/api/2.2.0/org/linqs/psl/database/QueryResultIterable.html) class.
...
A new class, [RuntimeStats](/api/2.2.0/org/linqs/psl/util/RuntimeStats.html),
